    ...
    <div className="space-y-0 bg-card min-h-screen p-7">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 24 }}>
        {[
          ...
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
            {i > 0 && <div style={{ width: 1, height: 28, background: 'hsl(var(--border))' }} />}
            <div>
              <div style={{
                fontFamily: "'Instrument Sans', sans-serif",
                fontWeight: 700,
              ...
              <div style={{ fontSize: 11, color: 'hsl(var(--muted-foreground))', marginTop: 2 }}>{s.label}</div>
            </div>
          </div>
        ))}
      </div>
            ...
            return (
              ...
              >
                ...
                <span style={{
                  ...
                  padding: '1px 6px',
                  borderRadius: 99,
                  background: isActive ? 'hsl(var(--brand-yellow))' : 'hsl(var(--muted))',
                  color: isActive ? 'hsl(var(--foreground))' : 'hsl(var(--muted-foreground))',
                }}>
                  {count}
                </span>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginBottom: 20 }}>
        <div style={{ position: 'relative', flex: 1, maxWidth: 320 }}>
          <Search style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: 'hsl(var(--muted-foreground))' }} size={14} />
          <input
            type="text"
        ...
        {!isMobile && (
          <div style={{ display: 'flex', border: '1px solid hsl(var(--border))', overflow: 'hidden' }}>
            {(['grid', 'list', 'kanban'] as ViewMode[]).map((mode, i) => (
              <button
                ...
                style={{
                  ...
                  color: viewMode === mode ? 'hsl(var(--brand-yellow))' : 'hsl(var(--muted-foreground))',
                  border: 'none',
      ...
      <div>
        {activeTab === 'archived' ? (
          filteredProjects.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '48px 0', border: '1px solid hsl(var(--border))' }}>
              <Archive size={40} style={{ margin: '0 auto 12px', color: 'hsl(var(--muted-foreground))' }} />
              <p style={{ fontFamily: "'Instrument Sans', sans-serif", fontWeight: 700, fontSize: 14, color: 'hsl(var(--foreground))', marginBottom: 4 }}>
              ...
              {filteredProjects.map((project) => (
                <div key={project.id} style={{ border: '1px solid hsl(var(--border))', background: 'hsl(var(--card))', padding: '18px 20px' }}>
                  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12 }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontFamily: "'Instrument Sans', sans-serif", fontWeight: 700, fontSize: 15, color: 'hsl(var(--foreground))', letterSpacing: '-0.02em', marginBottom: 4 }}>
                        {project.name}
                      </div>
                  ...
                  {project.description && (
                    <p style={{ fontSize: 12, color: 'hsl(var(--muted-foreground))', marginBottom: 12, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                      {project.description}
                    </p>
                  )}
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 8, marginTop: 12 }}>
                    ...
                    <ProtectedAction module="projects" action="delete">
                      <button
                        ...
                        style={{ display: 'flex', alignItems: 'center', gap: 6, fontFamily: "'Instrument Sans', sans-serif", fontWeight: 700, fontSize: 12, color: 'hsl(var(--card))', padding: '6px 12px', border: 'none', background: '#DC2626', cursor: 'pointer' }}
                      >
          ...
          <div style={{ textAlign: 'center', padding: '64px 20px', border: '1px solid hsl(var(--border))', background: 'hsl(var(--card))' }}>
            <div style={{ fontFamily: "'Instrument Sans', sans-serif", fontWeight: 700, fontSize: 15, color: 'hsl(var(--foreground))', marginBottom: 6 }}>
              Aucun projet trouvé
            </div>
