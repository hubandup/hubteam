...
export default function Feed() {
  ...
  return (
    <div className="w-full md:container md:mx-auto p-4 md:p-4 pb-24 md:pb-8 md:max-w-2xl">
      <div className="mb-4 md:mb-6">
        <h1 className="text-2xl md:text-3xl font-bold mb-1">Fil d'actualité</h1>
      ...
      <ScrollArea className="h-[calc(100vh-20rem)] md:h-[calc(100vh-16rem)]">
        <div className="space-y-4 md:space-y-4 pr-2">
