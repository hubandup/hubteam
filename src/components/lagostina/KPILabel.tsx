  ...
  return (
    <span className={`inline-flex items-center gap-1 ${className}`}>
      ...
      >
        ...
        {showTooltip && (
          <div className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 bg-[hsl(var(--brand-ink))] border border-[hsl(var(--brand-yellow))] p-3 text-xs font-['Instrument Sans']">
