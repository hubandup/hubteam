...
export function Sidebar() {
  ...
  const mainItems = [
    ...
    { title: 'Achats', url: '/achats/bons-de-commande', icon: ShoppingCart, module: 'dashboard' as const, matchParent: true, hideForClient: true, hideForAgency: true },
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild notch={location.pathname === '/announcements'}>
                    <NavLink
                      ...
                      activeClassName="bg-sidebar-primary text-sidebar-primary-foreground font-medium"
                    >
                      <Megaphone className="mr-2.5 h-4 w-4" />
                      <span>Informer</span>
                    </NavLink>
                  </SidebarMenuButton>
                </SidebarMenuItem>
