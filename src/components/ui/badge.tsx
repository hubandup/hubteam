...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2 py-0.5 text-[11px] font-semibold tracking-[0.02em] transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-ring/20",
  {
    variants: {
      variant: {
